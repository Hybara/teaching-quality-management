...
public class Evaluate {
  ...
  public Evaluate(ClassForTeacher classForTeacher, String text, String result, long creater,
  ...
  public Evaluate(long id, ClassForTeacher classForTeacher, String title, String text,
